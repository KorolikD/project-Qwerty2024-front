import{e as P,u as o,j as t,t as C,r as i,p as Q,L as ee,q as te,k as oe}from"./index-74324f87.js";import{s as z}from"./sprite-a5e91dfb.js";import{S as re,A as se,a as ne,I as ie,M as ae,L as ce,B as O}from"./BasicModalWindow-cc53706e.js";import{F as E,a as de,b as pe}from"./formik.esm-9171abe2.js";import{d as le}from"./dayjs.min-afc33561.js";import{S as xe}from"./SvgCustom-04f3b2ec.js";import{p as he}from"./hero-2x-31d4f1ba.js";import"./motion-9f2701e2.js";import"./zoom-f3fb213d.js";const ue=async()=>{try{return(await P.get("/products/categories")).data}catch(e){console.error(e)}},me=async({pageNumber:e,category:s,allowed:c,title:d})=>{try{const n={pageNumber:e};return n.allowed=c===!0||c===!1?c:n.allowed,n.category=s!==""?s:n.category,n.title=d!==""?d:n.title,(await P.get("/products",{params:n})).data}catch(n){console.error(n)}},ge=async()=>{try{return(await P.get("/users/current")).data}catch(e){console.error(e)}},fe=o.div`
