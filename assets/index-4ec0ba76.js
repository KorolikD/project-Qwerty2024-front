import{e as $,u as o,j as t,r as h,i as W,k as A}from"./index-bdf392bc.js";import{s as k}from"./SvgCustom-3cad93c7.js";import{B as R}from"./BasicModalWindow-54455549.js";import{F as O,a as T,b as P}from"./formik.esm-cd7c808f.js";import{d as L}from"./dayjs.min-4ef56250.js";import"./motion-38dcddb2.js";import"./zoom-401a75c6.js";const Y=async()=>{try{return(await $.get("/products/categories")).data}catch(e){console.error(e)}},E=async()=>{try{return(await $.get("/products")).data}catch(e){console.error(e)}},q=async()=>{try{return(await $.get("/users/current")).data}catch(e){console.error(e)}},U=o.div`
