import{e as P,u as o,j as t,t as C,r as i,p as Q,L as ee,q as te,k as oe}from"./index-16014985.js";import{s as z,S as re}from"./SvgCustom-0c137ba7.js";import{S as se,A as ne,a as ie,I as ae,M as ce,L as de,B as O}from"./BasicModalWindow-f6789526.js";import{F as E,a as pe,b as le}from"./formik.esm-98a38f87.js";import{d as xe}from"./dayjs.min-c07dee04.js";import{p as he}from"./hero-2x-31d4f1ba.js";import"./motion-69778a00.js";import"./zoom-b3b65e74.js";const ue=async()=>{try{return(await P.get("/products/categories")).data}catch(e){console.error(e)}},me=async({pageNumber:e,category:s,allowed:c,title:d})=>{try{const n={pageNumber:e};return n.allowed=c===!0||c===!1?c:n.allowed,n.category=s!==""?s:n.category,n.title=d!==""?d:n.title,(await P.get("/products",{params:n})).data}catch(n){console.error(n)}},ge=async()=>{try{return(await P.get("/users/current")).data}catch(e){console.error(e)}},fe=o.div`
