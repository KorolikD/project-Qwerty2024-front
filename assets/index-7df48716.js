import{e as P,u as o,j as t,L as K,t as V,r as a,p as X,k as Z}from"./index-d9d8eadf.js";import{s as C,S as Q}from"./SvgCustom-45bab02c.js";import{S as ee,W as te,I as oe,M as re,L as se,B}from"./BasicModalWindow-ef1c2713.js";import{F as ne,a as ie,b as M}from"./formik.esm-b1f67b40.js";import{d as ae}from"./dayjs.min-ad6a9ad5.js";import"./motion-75690cb5.js";import"./zoom-0c0b269d.js";const ce=async()=>{try{return(await P.get("/products/categories")).data}catch(e){console.error(e)}},de=async(e,s,l,n)=>{try{return(await P.get("/products",{params:{pageNumber:e,category:s,allowed:l,title:n}})).data}catch(c){console.error(c)}},le=async()=>{try{return(await P.get("/users/current")).data}catch(e){console.error(e)}},pe=o.div`
