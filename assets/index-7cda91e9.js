import{e as C,u as o,j as t,L,t as T,r as h,p as A,o as O}from"./index-b45f4a8d.js";import{s as $,S as Y}from"./SvgCustom-8ab7685d.js";import{S as E,W as q,I as U,M as V,L as _,B as M}from"./BasicModalWindow-0ea638d9.js";import{F as Q,a as G,b as I}from"./formik.esm-f1869d18.js";import{d as H}from"./dayjs.min-386ac3da.js";import"./motion-650b1511.js";import"./zoom-2952b212.js";const J=async()=>{try{return(await C.get("/products/categories")).data}catch(e){console.error(e)}},K=async()=>{try{return(await C.get("/products")).data}catch(e){console.error(e)}},X=async()=>{try{return(await C.get("/users/current")).data}catch(e){console.error(e)}},Z=o.div`
