...
`,Xn=S.img`
  width: 270px;
  margin-bottom: 14px;
  border: 1px solid ${I.colors.modalBorder};
  border-radius: 12px;
`,Yn=S.p`
  margin-top: 12px;
  font-weight: 400;
...
`,kn=S.li`
  ...
  border-radius: 12px;
  padding: 12px 18px;
  background-color: ${I.colors.modalListItem};
...
`;const lo=({isOpen:e,onRequestClose:t,children:n})=>J.jsx(J.Fragment,{children:J.jsxs($n,{centered:!0,open:e,closeIcon:!1,onCancel:t,footer:null,width:"auto",children:[J.jsx(Tn,{type:"button",onClick:t,children:J.jsx(ht,{icon:"icon-cross",size:"22",color:I.colors.white,stroke:I.colors.white,hover:I.colors.primary})}),n]})});export{lo as B,An as C,Zn as E,ro as I,io as L,to as M,Ln as N,no as S,qn as T,oo as W,Vn as a,Xn as b,Yn as c,Qn as d,kn as e,Jn as f,eo as g,ao as h,_n as i,jn as j,Fn as k,Dn as l,Kn as m,Gn as n,zn as o,Hn as p,Un as q,Wn as r};
