import{e as $,u as o,j as t,r as h,i as W,k as A}from"./index-5847dc1c.js";import{s as k}from"./SvgCustom-60b42b37.js";import{B as R}from"./BasicModalWindow-cf5e3c4e.js";import{F as O,a as T,b as P}from"./formik.esm-599dc61c.js";import{d as L}from"./dayjs.min-429476f1.js";import"./motion-92fcdb2b.js";import"./zoom-025f732b.js";const Y=async()=>{try{return(await $.get("/products/categories")).data}catch(e){console.error(e)}},E=async()=>{try{return(await $.get("/products")).data}catch(e){console.error(e)}},q=async()=>{try{return(await $.get("/users/current")).data}catch(e){console.error(e)}},U=o.div`
