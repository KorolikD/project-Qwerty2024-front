import{e as P,u as o,j as t,L as K,t as V,r as a,p as X,k as Z}from"./index-73b20fdb.js";import{s as C,S as Q}from"./SvgCustom-4c091665.js";import{S as ee,W as te,I as oe,M as re,L as se,B}from"./BasicModalWindow-02969783.js";import{F as ne,a as ie,b as M}from"./formik.esm-94e60cec.js";import{d as ae}from"./dayjs.min-98fc23fd.js";import"./motion-45fa91ce.js";import"./zoom-58b06cef.js";const ce=async()=>{try{return(await P.get("/products/categories")).data}catch(e){console.error(e)}},de=async(e,s,l,n)=>{try{return(await P.get("/products",{params:{pageNumber:e,category:s,allowed:l,title:n}})).data}catch(c){console.error(c)}},le=async()=>{try{return(await P.get("/users/current")).data}catch(e){console.error(e)}},pe=o.div`
