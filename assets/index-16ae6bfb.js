...
`,_r=y.p`
  ...
  color: grey;
  margin-top: 2px;
`,Zr=({subcategory:e,onSelect:t})=>f.jsx(Kr,{onClick:()=>t(e.filter,e.name.toLowerCase()),children:f.jsxs(Xr,{style:{backgroundImage:`linear-gradient(rgba(4, 4, 4, 0.5), rgba(4, 4, 4, 0.5)), url(${e.imgURL})`},children:[f.jsx(qr,{children:e.name}),f.jsx(_r,{children:e.filter})]})}),Gr=y.ul`
