import{e as P,u as o,j as t,L as K,t as V,r as a,p as X,o as Z}from"./index-4ba4a0cd.js";import{s as C,S as Q}from"./SvgCustom-ed9d0354.js";import{S as ee,W as te,I as oe,M as re,L as se,B}from"./BasicModalWindow-a776695b.js";import{F as ne,a as ie,b as M}from"./formik.esm-3917f13d.js";import{d as ae}from"./dayjs.min-71ed43ab.js";import"./motion-cbed674a.js";import"./zoom-e2c9e285.js";const ce=async()=>{try{return(await P.get("/products/categories")).data}catch(e){console.error(e)}},de=async(e,s,l,n)=>{try{return(await P.get("/products",{params:{pageNumber:e,category:s,allowed:l,title:n}})).data}catch(c){console.error(c)}},le=async()=>{try{return(await P.get("/users/current")).data}catch(e){console.error(e)}},pe=o.div`
