import{e as $,u as o,j as t,r as h,i as W,k as A}from"./index-11e4c677.js";import{s as k}from"./SvgCustom-9aa9d742.js";import{B as R}from"./BasicModalWindow-494eb114.js";import{F as O,a as T,b as P}from"./formik.esm-26faa1a9.js";import{d as L}from"./dayjs.min-36cbd0cc.js";import"./motion-d14b520c.js";import"./zoom-29e4431c.js";const Y=async()=>{try{return(await $.get("/products/categories")).data}catch(e){console.error(e)}},E=async()=>{try{return(await $.get("/products")).data}catch(e){console.error(e)}},q=async()=>{try{return(await $.get("/users/current")).data}catch(e){console.error(e)}},U=o.div`
