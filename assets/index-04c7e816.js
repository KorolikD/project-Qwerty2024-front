import{e as z,u as o,j as t,L as K,t as V,r as i,p as X,k as Z}from"./index-75571770.js";import{s as C,S as Q}from"./SvgCustom-84aebcff.js";import{S as ee,W as te,I as oe,M as re,L as se,B}from"./BasicModalWindow-998217a4.js";import{F as ne,a as ie,b as M}from"./formik.esm-af1c7ae5.js";import{d as ae}from"./dayjs.min-cb1dff3a.js";import{p as ce}from"./hero-2x-31d4f1ba.js";import"./motion-418da5ee.js";import"./zoom-b672d52b.js";const de=async()=>{try{return(await z.get("/products/categories")).data}catch(e){console.error(e)}},le=async(e,s,l,a)=>{try{return(await z.get("/products",{params:{pageNumber:e,category:s,allowed:l,title:a}})).data}catch(d){console.error(d)}},pe=async()=>{try{return(await z.get("/users/current")).data}catch(e){console.error(e)}},xe=o.div`
