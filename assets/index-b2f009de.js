import{e as $,u as o,j as t,r as h,i as W,k as A}from"./index-d26f62b3.js";import{s as k}from"./SvgCustom-153ad27a.js";import{B as R}from"./BasicModalWindow-dde8acc9.js";import{F as O,a as T,b as P}from"./formik.esm-c0c195aa.js";import{d as L}from"./dayjs.min-b675ad4b.js";import"./motion-12812518.js";import"./zoom-2f7cd590.js";const Y=async()=>{try{return(await $.get("/products/categories")).data}catch(e){console.error(e)}},E=async()=>{try{return(await $.get("/products")).data}catch(e){console.error(e)}},q=async()=>{try{return(await $.get("/users/current")).data}catch(e){console.error(e)}},U=o.div`
