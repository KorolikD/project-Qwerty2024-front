import{e as P,u as o,j as t,t as C,r as s,p as J,L as K,q as X,k as Z}from"./index-856b5edb.js";import{s as z,S as Q}from"./SvgCustom-58ed029e.js";import{S as ee,A as te,a as oe,I as re,M as ne,L as se,B}from"./BasicModalWindow-2622980a.js";import{F as D,a as ie,b as ae}from"./formik.esm-1f97a0c8.js";import{d as ce}from"./dayjs.min-3d98a94e.js";import{p as de}from"./hero-2x-31d4f1ba.js";import"./motion-0d659195.js";import"./zoom-9be8e2e7.js";const pe=async()=>{try{return(await P.get("/products/categories")).data}catch(e){console.error(e)}},le=async(e,n,l,a)=>{try{return(await P.get("/products",{params:{pageNumber:e,category:n,allowed:l,title:a}})).data}catch(d){console.error(d)}},xe=async()=>{try{return(await P.get("/users/current")).data}catch(e){console.error(e)}},he=o.div`
