import{u as n,r as C,j as e,t as d,i as x,s as k,k as w,N as W,a as S,m as N,n as A,o as L}from"./index-75571770.js";import{d as v}from"./dayjs.min-cb1dff3a.js";import{C as O,D as Y,a as _,b as j,S as u,c as b,A as R,T as q}from"./DayDashboard.styled-2c5aee00.js";import{S as l}from"./SvgCustom-84aebcff.js";import{M as T}from"./react-responsive-301aaf9d.js";import"./motion-418da5ee.js";import"./index-75d9d14b.js";import"./ResizeObserver.es-f4289e8a.js";const H=i=>i.diary.productsList,U=i=>i.diary.exercisesList,G=i=>i.diary.totalCalories,Q=i=>i.diary.burnedCalories,J=i=>i.diary.timeSpentOnExercises,K=i=>i.diary.isLoading,B=i=>i.diary.updateDiaryProducts,F=i=>i.diary.updateDiaryExercises,V=n.div`
  display: flex;
  gap: 20px;
  align-items: center;
...
`,oe=({list:i,forExercisesTable:o,forProductsTable:p,onDelete:s})=>{const{blood:a}=x(k),h=x(B),c=x(F);return e.jsxs(e.Fragment,{children:[c?e.jsx(w,{}):e.jsx(e.Fragment,{children:o&&e.jsxs(M,{children:[e.jsx(ne,{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Body Part"}),e.jsx("th",{children:"Equipment"}),e.jsx("th",{children:"Name"}),e.jsx("th",{children:"Target"}),e.jsx("th",{children:"Burned Calories"}),e.jsx("th",{children:"Time"}),e.jsx("th",{})]})}),e.jsx(se,{children:i.map(r=>e.jsxs("tr",{children:[e.jsx(g,{children:r.exerciseId.bodyPart}),e.jsx(g,{children:r.exerciseId.equipment}),e.jsx(g,{children:r.exerciseId.name}),e.jsx(g,{children:r.exerciseId.target}),e.jsx(g,{children:Math.round(r.burnedCalories)}),e.jsx(g,{children:r.time.toFixed(2)}),e.jsx("td",{children:e.jsx(P,{onClick:()=>{s({id:r._id})},children:e.jsx(l,{icon:"icon-trash",size:"20",stroke:d.colors.secondary})})})]},r._id))})]})}),h?e.jsx(w,{}):e.jsx(e.Fragment,{children:p&&e.jsxs(M,{children:[e.jsx(re,{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Title"}),e.jsx("th",{children:"Category"}),e.jsx("th",{children:"Calories"}),e.jsx("th",{children:"Weight"}),e.jsx("th",{children:"Recommend"}),e.jsx("th",{})]})}),e.jsx(te,{children:i.map(r=>e.jsxs("tr",{children:[e.jsx(g,{children:r.productId.title}),e.jsx(g,{children:r.productId.category}),e.jsx(g,{children:Math.round(r.calories)}),e.jsx(g,{children:Math.round(r.weight)}),e.jsx(g,{$recommend:!0,$color:r.productId.groupBloodNotAllowed[a],children:r.productId.groupBloodNotAllowed[a]?"Yes":"No"}),e.jsx("td",{children:e.jsx(P,{onClick:()=>{s({id:r._id})},children:e.jsx(l,{icon:"icon-trash",size:"20",stroke:d.colors.secondary})})})]},r._id))})]})})]})},de=n.div`
  position: relative;
  overflow: hidden;
  margin: 0 auto;
