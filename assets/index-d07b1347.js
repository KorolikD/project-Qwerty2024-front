import{e as $,u as o,j as t,r as p,f as L,h as A}from"./index-f4f0eb10.js";import{s as w}from"./sprite-34ae3165.js";const N=async()=>{try{return(await $.get("/products/categories")).data}catch(e){console.error(e)}},T=async()=>{try{return(await $.get("/products")).data}catch(e){console.error(e)}},E=async()=>{try{return(await $.get("/users/current")).data}catch(e){console.error(e)}},D=o.div`
...
`,M=({onSubmit:e,handleClear:a,categories:n,onUpdateCategory:i,onUpdateRecommendation:x,inputValue:h})=>t.jsxs(D,{children:[t.jsx(Y,{children:"Products"}),t.jsxs(q,{children:[t.jsxs(O,{children:[t.jsx(U,{type:"text",autoComplete:"off",autoFocus:!0,placeholder:"Search"}),t.jsx(V,{type:"submit",onClick:r=>{e(r.target.previousElementSibling.value),r.preventDefault()},children:t.jsx(_,{width:"24",height:"24",children:t.jsx("use",{href:w+"#icon-search"})})}),h&&t.jsx(G,{type:"submit",onClick:r=>{r.preventDefault()},children:t.jsx(H,{width:"18",height:"18",children:t.jsx("use",{href:w+"#icon-cross"})})})]}),t.jsxs(J,{name:"category",onChange:r=>i(r.target.value),children:[t.jsx(u,{value:"categories",children:"Categories"}),n.map(r=>t.jsx(u,{value:r,children:r},r))]}),t.jsxs(K,{name:"recommendation",onChange:r=>x(r.target.value),children:[t.jsx(u,{value:"All",children:"All"}),t.jsx(u,{value:"Recommended",children:"Recommended"}),t.jsx(u,{value:"Not recommended",children:"Not recommended"})]})]})]}),Q=o.div`
  width: 335px;
