import{e as P,u as o,j as t,L as K,t as V,r as a,p as X,k as Z}from"./index-f6852527.js";import{s as C,S as Q}from"./SvgCustom-e7513403.js";import{S as ee,W as te,I as oe,M as re,L as se,B}from"./BasicModalWindow-c704f0c3.js";import{F as ne,a as ie,b as M}from"./formik.esm-3f9b6fb8.js";import{d as ae}from"./dayjs.min-3ccfd7aa.js";import"./motion-97893e20.js";import"./zoom-a0ee108d.js";const ce=async()=>{try{return(await P.get("/products/categories")).data}catch(e){console.error(e)}},de=async(e,s,l,n)=>{try{return(await P.get("/products",{params:{pageNumber:e,category:s,allowed:l,title:n}})).data}catch(c){console.error(c)}},le=async()=>{try{return(await P.get("/users/current")).data}catch(e){console.error(e)}},pe=o.div`
