import{e as z,u as o,j as t,L as K,t as V,r as i,p as X,k as Z}from"./index-8770fb6a.js";import{s as C,S as Q}from"./SvgCustom-39e0ee6d.js";import{S as ee,W as te,I as oe,M as re,L as se,B}from"./BasicModalWindow-fbc587c6.js";import{F as ne,a as ie,b as M}from"./formik.esm-de3fe2be.js";import{d as ae}from"./dayjs.min-44fa5403.js";import{p as ce}from"./hero-2x-31d4f1ba.js";import"./motion-721f62e8.js";import"./zoom-e8be0d23.js";const de=async()=>{try{return(await z.get("/products/categories")).data}catch(e){console.error(e)}},le=async(e,s,l,a)=>{try{return(await z.get("/products",{params:{pageNumber:e,category:s,allowed:l,title:a}})).data}catch(d){console.error(d)}},pe=async()=>{try{return(await z.get("/users/current")).data}catch(e){console.error(e)}},xe=o.div`
