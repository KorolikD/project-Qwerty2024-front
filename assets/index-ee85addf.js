import{e as $,u as o,j as t,r as h,i as W,k as A}from"./index-a929bb4f.js";import{s as k}from"./SvgCustom-e557b7ad.js";import{B as R}from"./BasicModalWindow-7bdb0bb6.js";import{F as O,a as T,b as P}from"./formik.esm-b85c08e2.js";import{d as L}from"./dayjs.min-817745df.js";import"./motion-bcff0f11.js";import"./zoom-a2db843c.js";const Y=async()=>{try{return(await $.get("/products/categories")).data}catch(e){console.error(e)}},E=async()=>{try{return(await $.get("/products")).data}catch(e){console.error(e)}},q=async()=>{try{return(await $.get("/users/current")).data}catch(e){console.error(e)}},U=o.div`
